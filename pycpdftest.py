...
print('---cpdf_toFile')
try: pycpdf.toFile(pdf5, 'testoutputs/blank.pdf', False, False)
except: prerr()
print('---cpdf_blankDocumentPaper')
try: pdf6 = pycpdf.blankDocumentPaper(pycpdf.a3landscape, 50)
except: fatal_prerr()
try: pycpdf.toFile(pdf6, 'testoutputs/blank2.pdf', False, False)
except: prerr()
...
print('---cpdf_toFile')
try: pycpdf.toFile(pdf4, 'testoutputs/toFile.pdf', False, False)
except: prerr()
print('---cpdf_toFileExt')
try: pycpdf.toFileExt(pdf4, 'testoutputs/toFileExt.pdf', False, False, False, False, False)
except: prerr()
print('---cpdf_toMemory')
...
try: pycpdf.toFileEncrypted(pdf5, pycpdf.pdf40bit, [pycpdf.noEdit], 'owner', 'user', False, False, 'testoutputs/enc.pdf')
except: prerr()
print('---cpdf_toFileEncryptedExt')
try: pycpdf.toFileEncryptedExt(pdf5, pycpdf.pdf40bit, [pycpdf.noEdit], 'owner', 'user', False, False, False, False, False, 'testoutputs/enc2.pdf')
except: prerr()
try: encpdf = pycpdf.fromFile('testoutputs/enc.pdf', 'user')
except: fatal_prerr()
print('---cpdf_decryptPdf')
try: decrypted = pycpdf.decryptPdf(encpdf, 'user')
except: fatal_prerr()
try: encpdf2 = pycpdf.fromFile('testoutputs/enc.pdf', 'user')
except: fatal_prerr()
...
try: pycpdf.toFile(merged, 'testoutputs/merged.pdf', False, False)
except: prerr()
print('---cpdf_merge')
try: merged2 = pycpdf.merge([pdf, pdf2], True, False)
except: fatal_prerr()
try: pycpdf.toFile(merged2, 'testoutputs/merged2.pdf', False, False)
except: prerr()
...
try: pycpdf.toFile(same, 'testoutputs/same.pdf', False, False)
except: prerr()
print('---cpdf_selectPages')
try: selected = pycpdf.selectPages(pdf, pycpdf.even(pycpdf.all(pdf)))
except: fatal_prerr()
try: pycpdf.toFile(selected, 'testoutputs/selected.pdf', False, False)
except: prerr()
...
try: pycpdf.toFile(pdf, 'testoutputs/squeezed.pdf', False, False)
except: prerr()
...
try: pycpdf.outputJSON('testoutputs/filename.txt', True, False, pdf)
except: prerr()
