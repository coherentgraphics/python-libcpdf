...
try: pycpdf.toFile(pdf3, 'testoutputs/01fromMemory.pdf', False, False)
except: prerr()
print('---cpdf_fromMemoryLazy')
try: pdf4 = pycpdf.fromMemoryLazy(data, '')
except: fatal_prerr()
try: pycpdf.toFile(pdf4, 'testoutputs/01fromMemoryLazy.pdf', False, False)
except: prerr()
print('---cpdf_blankDocument')
try: pdf5 = pycpdf.blankDocument(100.0, 200.0, 20)
except: fatal_prerr()
print('---cpdf_toFile')
try: pycpdf.toFile(pdf5, 'testoutputs/01blank.pdf', False, False)
except: prerr()
print('---cpdf_blankDocumentPaper')
try: pdf6 = pycpdf.blankDocumentPaper(pycpdf.a4portrait, 10)
except: fatal_prerr()
...
try: pdf5 = pycpdf.fromFile('cpdflibmanual.pdf', '')
except: prerr()
...
try: pdf2 = pycpdf.fromFile('cpdflibmanual.pdf', '')
except: fatal_prerr()
print('---cpdf_mergeSimple')
print(pdf, pdf2)
try: merged = pycpdf.mergeSimple([pdf, pdf, pdf])
except: fatal_prerr()
...
try: pagespdf1 = pycpdf.fromFile('cpdflibmanual.pdf', '')
except: fatal_prerr()
try: pagespdf2 = pycpdf.fromFile('cpdflibmanual.pdf', '')
except: fatal_prerr()
try: pagespdf3 = pycpdf.fromFile('cpdflibmanual.pdf', '')
except: fatal_prerr()
try: pagespdf4 = pycpdf.fromFile('cpdflibmanual.pdf', '')
except: fatal_prerr()
try: pagespdf5 = pycpdf.fromFile('cpdflibmanual.pdf', '')
except: fatal_prerr()
try: pagespdf6 = pycpdf.fromFile('cpdflibmanual.pdf', '')
except: fatal_prerr()
try: pagespdf7 = pycpdf.fromFile('cpdflibmanual.pdf', '')
except: fatal_prerr()
try: pagespdf8 = pycpdf.fromFile('cpdflibmanual.pdf', '')
except: fatal_prerr()
try: pagespdf9 = pycpdf.fromFile('cpdflibmanual.pdf', '')
except: fatal_prerr()
try: pagespdf10 = pycpdf.fromFile('cpdflibmanual.pdf', '')
except: fatal_prerr()
try: pagespdf11 = pycpdf.fromFile('cpdflibmanual.pdf', '')
except: fatal_prerr()
try: pagespdf12 = pycpdf.fromFile('cpdflibmanual.pdf', '')
except: fatal_prerr()
try: pagespdf13 = pycpdf.fromFile('cpdflibmanual.pdf', '')
except: fatal_prerr()
try: pagespdf14 = pycpdf.fromFile('cpdflibmanual.pdf', '')
except: fatal_prerr()
try: pagespdf15 = pycpdf.fromFile('cpdflibmanual.pdf', '')
except: fatal_prerr()
try: pagespdf16 = pycpdf.fromFile('cpdflibmanual.pdf', '')
except: fatal_prerr()
try: pagespdf17 = pycpdf.fromFile('cpdflibmanual.pdf', '')
except: fatal_prerr()
try: pagespdf18 = pycpdf.fromFile('cpdflibmanual.pdf', '')
except: fatal_prerr()
try: pagespdf19 = pycpdf.fromFile('cpdflibmanual.pdf', '')
except: fatal_prerr()
try: r = pycpdf.all(pagespdf1)
except: fatal_prerr()
print('---cpdf_scalePages')
try: pycpdf.scalePages(pagespdf1, r, 1.5, 1.8)
except: prerr()
try: pycpdf.toFile(pagespdf1, 'testoutputs/03scalepages.pdf', False, False)
except: prerr()
print('---cpdf_scaleToFit')
try: pycpdf.scaleToFit(pagespdf2, r, 1.5, 1.8, 0.9)
except: prerr()
try: pycpdf.toFile(pagespdf2, 'testoutputs/03scaletofit.pdf', False, False)
except: prerr()
print('---cpdf_scaleToFitPaper')
try: pycpdf.scaleToFitPaper(pagespdf3, r, pycpdf.a4portrait, 0.8)
except: prerr()
try: pycpdf.toFile(pagespdf3, 'testoutputs/03scaletofitpaper.pdf', False, False)
except: prerr()
print('---cpdf_scaleContents')
try: pycpdf.scaleContents(pagespdf4, r, (pycpdf.topLeft, 20, 20), 2.0)
except: prerr()
try: pycpdf.toFile(pagespdf4, 'testoutputs/03scalecontents.pdf', False, False)
except: prerr()
print('---cpdf_shiftContents')
try: pycpdf.shiftContents(pagespdf5, r, 1.5, 1.25)
except: prerr()
try: pycpdf.toFile(pagespdf5, 'testoutputs/03shiftcontents.pdf', False, False)
except: prerr()
print('---cpdf_rotate')
try: pycpdf.rotate(pagespdf6, r, 90)
except: prerr()
try: pycpdf.toFile(pagespdf6, 'testoutputs/03rotate.pdf', False, False)
except: prerr()
print('---cpdf_rotateBy')
try: pycpdf.rotateBy(pagespdf7, r, 90)
except: prerr()
try: pycpdf.toFile(pagespdf7, 'testoutputs/03rotateby.pdf', False, False)
except: prerr()
print('---cpdf_rotateContents')
try: pycpdf.rotateContents(pagespdf8, r, 35.0)
except: prerr()
try: pycpdf.toFile(pagespdf8, 'testoutputs/03rotatecontents.pdf', False, False)
except: prerr()
print('---cpdf_upright')
try: pycpdf.upright(pagespdf9, r)
except: prerr()
try: pycpdf.toFile(pagespdf9, 'testoutputs/03upright.pdf', False, False)
except: prerr()
print('---cpdf_hFlip')
try: pycpdf.hFlip(pagespdf10, r)
except: prerr()
try: pycpdf.toFile(pagespdf10, 'testoutputs/03hflip.pdf', False, False)
except: prerr()
print('---cpdf_vFlip')
try: pycpdf.vFlip(pagespdf11, r)
except: prerr()
try: pycpdf.toFile(pagespdf11, 'testoutputs/03vflip.pdf', False, False)
except: prerr()
print('---cpdf_crop')
try: pycpdf.crop(pagespdf12, r, 0.0, 0.0, 400.0, 500.0)
except: prerr()
try: pycpdf.toFile(pagespdf12, 'testoutputs/03crop.pdf', False, False)
except: prerr()
print('---cpdf_removeCrop')
try: pycpdf.removeCrop(pagespdf13, r)
except: prerr()
try: pycpdf.toFile(pagespdf13, 'testoutputs/03remove_crop.pdf', False, False)
except: prerr()
print('---cpdf_removeTrim')
try: pycpdf.removeTrim(pagespdf14, r)
except: prerr()
try: pycpdf.toFile(pagespdf14, 'testoutputs/03remove_trim.pdf', False, False)
except: prerr()
print('---cpdf_removeArt')
try: pycpdf.removeArt(pagespdf15, r)
except: prerr()
try: pycpdf.toFile(pagespdf15, 'testoutputs/03remove_art.pdf', False, False)
except: prerr()
print('---cpdf_removeBleed')
try: pycpdf.removeBleed(pagespdf16, r)
except: prerr()
try: pycpdf.toFile(pagespdf16, 'testoutputs/03remove_bleed.pdf', False, False)
except: prerr()
print('---cpdf_trimMarks')
try: pycpdf.trimMarks(pagespdf17, r)
except: prerr()
try: pycpdf.toFile(pagespdf17, 'testoutputs/03trim_marks.pdf', False, False)
except: prerr()
print('---cpdf_showBoxes')
try: pycpdf.showBoxes(pagespdf18, r)
except: prerr()
try: pycpdf.toFile(pagespdf18, 'testoutputs/03show_boxes.pdf', False, False)
except: prerr()
print('---cpdf_hardBox')
try: pycpdf.hardBox(pagespdf19, r, "/MediaBox")
except: prerr()
try: pycpdf.toFile(pagespdf19, 'testoutputs/03hard_box.pdf', False, False)
except: prerr()
...
try: pycpdf.toFile(pdf, 'testoutputs/08stamp_after.pdf', False, False)
except: prerr()
try: pycpdf.toFile(pdf, 'testoutputs/08stampee_after.pdf', False, False)
except: prerr()
print('---cpdf_combinePages')
try: pycpdf.combinePages(pdf, pdf2)
except: prerr()
try: pycpdf.toFile(pdf, 'testoutputs/08c3after.pdf', False, False)
except: prerr()
print('---cpdf_addText')
...
try: pycpdf.toFile(pdf, 'testoutputs/08added_text.pdf', False, False)
except: prerr()
print('---cpdf_removeText')
try: pycpdf.removeText(pdf, r)
except: prerr()
try: pycpdf.toFile(pdf, 'testoutputs/08removed_text.pdf', False, False)
except: prerr()
...
try: pycpdf.toFile(pdf, 'testoutputs/08demo.pdf', False, False)
except: prerr()
...
try: pycpdf.toFile(mp, 'testoutputs/09mp.pdf', False, False)
except: prerr()
print('---cpdf_twoUpStack')
try: pycpdf.twoUpStack(mp2)
except: prerr()
try: pycpdf.toFile(mp2, 'testoutputs/09mp2.pdf', False, False)
except: prerr()
print('---cpdf_padBefore')
r = list(range(1, 11))
try: pycpdf.padBefore(mp3, r)
except: prerr()
try: pycpdf.toFile(mp3, 'testoutputs/09mp3.pdf', False, False)
except: prerr()
print('---cpdf_padAfter')
try: pycpdf.padAfter(mp4, r)
except: prerr()
try: pycpdf.toFile(mp4, 'testoutputs/09mp4.pdf', False, False)
except: prerr()
print('---cpdf_padEvery')
try: pycpdf.padEvery(mp5, 5)
except: prerr()
try: pycpdf.toFile(mp5, 'testoutputs/09mp5.pdf', False, False)
except: prerr()
print('---cpdf_padMultiple')
try: pycpdf.padMultiple(mp6, 10)
except: prerr()
try: pycpdf.toFile(mp6, 'testoutputs/09mp6.pdf', False, False)
except: prerr()
print('---cpdf_padMultipleBefore')
try: pycpdf.padMultipleBefore(mp7, 23)
except: prerr()
try: pycpdf.toFile(mp7, 'testoutputs/09mp7.pdf', False, False)
except: prerr()
...
try: pycpdf.toFile(pdf, 'testoutputs/11setinfo.pdf', False, False)
except: prerr()
try:
...
try: pycpdf.toFile(pdf, 'testoutputs/11setboxes.pdf', False, False)
except: prerr()
...
try: pycpdf.toFile(pdf, 'testoutputs/11trapped.pdf', False, False)
except: prerr()
...
try: pycpdf.toFile(pdf, 'testoutputs/11untrapped.pdf', False, False)
except: prerr()
...
try: pycpdf.toFile(pdf, 'testoutputs/11open.pdf', False, False)
except: prerr()
print('---cpdf_setMetadataFromFile')
try: pycpdf.setMetadataFromFile(pdf, 'testinputs/metadata.txt')
except: prerr()
try: pycpdf.toFile(pdf, 'testoutputs/11metadata1.pdf', False, False)
except: prerr()
print('---cpdf_setMetadataFromByteArray')
try: pycpdf.setMetadataFromByteArray(pdf, 'data')
except: prerr()
try: pycpdf.toFile(pdf, 'testoutputs/11metadata2.pdf', False, False)
except: prerr()
...
try: pycpdf.toFile(pdf, 'testoutputs/11metadata3.pdf', False, False)
except: prerr()
print('---cpdf_setMetadataDate')
try: pycpdf.setMetadataDate(pdf, 'now')
except: prerr()
try: pycpdf.toFile(pdf, 'testoutputs/11metadata4.pdf', False, False)
except: prerr()
...
try: pycpdf.addPageLabels(pdf, (pycpdf.decimalArabic, "PREFIX-", 1, pycpdf.all(pdf)), False)
except: prerr()
...
try: pycpdf.toFile(pdf, 'testoutputs/11pagelabels.pdf', False, False)
except: prerr()

# CHAPTER 12. File Attachments
print('***** CHAPTER 12. File Attachments')
try: pdf = pycpdf.fromFile('testinputs/has_attachments.pdf', '')
except: fatal_prerr()
print('---cpdf_attachFile')
try: pycpdf.attachFile('testinputs/image.pdf', pdf)
except: prerr()
print('---cpdf_attachFileToPage')
try: pycpdf.attachFileToPage('testinputs/image.pdf', pdf, 1)
except: prerr()
print('---cpdf_attachFileFromMemory')
try: pycpdf.attachFileFromMemory('', 'metadata.txt', pdf)
except: prerr()
print('---cpdf_attachFileToPageFromMemory')
try: pycpdf.attachFileToPageFromMemory('', 'metadata.txt', pdf, 1)
except: prerr()
try: pycpdf.toFile(pdf, 'testoutputs/12with_attachments.pdf', False, False)
except: prerr()
print('---cpdf_removeAttachedFiles')
try: pycpdf.removeAttachedFiles(pdf)
except: prerr()
try: pycpdf.toFile(pdf, 'testoutputs/12removed_attachments.pdf', False, False)
except: prerr()
...
try: pycpdf.toFile(pdf, 'testoutputs/14remove_fonts.pdf', False, False)
except: prerr()
print('---cpdf_copyFont')
...
try: misc = pycpdf.fromFile('cpdflibmanual.pdf', '')
except: fatal_prerr()
try: misc2 = pycpdf.fromFile('cpdflibmanual.pdf', '')
except: fatal_prerr()
try: misc3 = pycpdf.fromFile('cpdflibmanual.pdf', '')
except: fatal_prerr()
try: misc4 = pycpdf.fromFile('cpdflibmanual.pdf', '')
except: fatal_prerr()
try: misc5 = pycpdf.fromFile('cpdflibmanual.pdf', '')
except: fatal_prerr()
try: misc6 = pycpdf.fromFile('cpdflibmanual.pdf', '')
except: fatal_prerr()
try: misc7 = pycpdf.fromFile('cpdflibmanual.pdf', '')
except: fatal_prerr()
try: misc8 = pycpdf.fromFile('cpdflibmanual.pdf', '')
except: fatal_prerr()
try: misc9 = pycpdf.fromFile('cpdflibmanual.pdf', '')
except: fatal_prerr()
try: misc10 = pycpdf.fromFile('cpdflibmanual.pdf', '')
except: fatal_prerr()
try: misc11 = pycpdf.fromFile('cpdflibmanual.pdf', '')
except: fatal_prerr()
try: misc12 = pycpdf.fromFile('cpdflibmanual.pdf', '')
except: fatal_prerr()
try: misclogo = pycpdf.fromFile('logo.pdf', '')
except: fatal_prerr()
r = pycpdf.all(misc)
print('---cpdf_draft')
try: pycpdf.draft(misc, r, True)
except: prerr()
try: pycpdf.toFile(misc, 'testoutputs/17draft.pdf', False, False)
except: prerr()
print('---cpdf_removeAllText')
try: pycpdf.removeAllText(misc2, r)
except: prerr()
try: pycpdf.toFile(misc2, 'testoutputs/17removealltext.pdf', False, False)
except: prerr()
print('---cpdf_blackText')
try: pycpdf.blackText(misc3, r)
except: prerr()
try: pycpdf.toFile(misc3, 'testoutputs/17blacktext.pdf', False, False)
except: prerr()
print('---cpdf_blackLines')
try: pycpdf.blackLines(misc4, r)
except: prerr()
try: pycpdf.toFile(misc4, 'testoutputs/17blacklines.pdf', False, False)
except: prerr()
print('---cpdf_blackFills')
try: pycpdf.blackFills(misc5, r)
except: prerr()
try: pycpdf.toFile(misc5, 'testoutputs/17blackfills.pdf', False, False)
except: prerr()
print('---cpdf_thinLines')
try: pycpdf.thinLines(misc6, r, 2.0)
except: prerr()
try: pycpdf.toFile(misc6, 'testoutputs/17thinlines.pdf', False, False)
except: prerr()
print('---cpdf_copyId')
try: pycpdf.copyId(misclogo, misc7)
except: prerr()
try: pycpdf.toFile(misc7, 'testoutputs/17copyid.pdf', False, False)
except: prerr()
print('---cpdf_removeId')
try: pycpdf.removeId(misc8)
except: prerr()
try: pycpdf.toFile(misc8, 'testoutputs/17removeid.pdf', False, False)
except: prerr()
print('---cpdf_setVersion')
try: pycpdf.setVersion(misc9, 1)
except: prerr()
try: pycpdf.toFile(misc9, 'testoutputs/17setversion.pdf', False, False)
except: prerr()
print('---cpdf_setFullVersion')
try: pycpdf.setFullVersion(misc10, 2, 0)
except: prerr()
try: pycpdf.toFile(misc10, 'testoutputs/17setfullversion.pdf', False, False)
except: prerr()
print('---cpdf_removeDictEntry')
try: pycpdf.removeDictEntry(misc11, '/Producer')
except: prerr()
try: pycpdf.toFile(misc11, 'testoutputs/17removedictentry.pdf', False, False)
except: prerr()
print('---cpdf_removeClipping')
try: pycpdf.removeClipping(misc12, r)
except: prerr()
try: pycpdf.toFile(misc12, 'testoutputs/17removeclipping.pdf', False, False)
except: prerr()
