...
try: pycpdf.toFile(same, 'testoutputs/02same.pdf', False, False)
except: prerr()
...
pycpdf.toFile(pdf, 'testoutputs/05squeezed.pdf', False, False)
...
try: pycpdf.toFile(pdf, 'testoutputs/09squeezed.pdf', False, False)
except: prerr()
...
try: pycpdf.outputJSON('testoutputs/16filename.txt', True, False, pdf)
except: prerr()
